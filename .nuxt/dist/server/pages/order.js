...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/order.vue?vue&type=template&id=57c5adc0&
var ordervue_type_template_id_57c5adc0_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"col-md-7",on:{"submit":function($event){$event.preventDefault();return _vm.addData($event)}}},[_c('v-row',[_c('v-col',{attrs:{"cols":"5","md":"4"}},[_c('h1',[_vm._v("Name")]),_vm._v(" "),_c('v-text-field',{attrs:{"required":""},model:{value:(_vm.name),callback:function ($$v) {_vm.name=$$v},expression:"name"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"5","md":"4"}},[_c('h1',[_vm._v("Phone")]),_vm._v(" "),_c('v-text-field',{attrs:{"required":""},model:{value:(_vm.Phone),callback:function ($$v) {_vm.Phone=$$v},expression:"Phone"}})],1)],1),_vm._ssrNode(" "),_vm._ssrNode("<div>","</div>",[[_c('v-container',{attrs:{"fluid":""}},[_c('h1',[_vm._v("Product list (รายการสินค้า)")]),_vm._v(" "),_c('v-radio-group',{attrs:{"mandatory":false},model:{value:(_vm.Product),callback:function ($$v) {_vm.Product=$$v},expression:"Product"}},[_c('v-radio',{attrs:{"label":"Espresso (เอสเพรสโซ่)","value":"Espresso"}}),_vm._v(" "),_c('v-radio',{attrs:{"label":"Americano (อเมริกาโน่)","value":"Americano"}}),_vm._v(" "),_c('v-radio',{attrs:{"label":"Latte (ลาเต้)","value":"Latte"}}),_vm._v(" "),_c('v-radio',{attrs:{"label":"Cappuccino (คาปูชิโน)","value":"Cappuccino"}}),_vm._v(" "),_c('v-radio',{attrs:{"label":"Mocha (มอคค่า)","value":"Mocha"}})],1)],1)],_vm._ssrNode(" "),[_c('v-container',{attrs:{"fluid":""}},[_c('h1',[_vm._v("Category (ประเภท)")]),_vm._v(" "),_c('v-radio-group',{attrs:{"mandatory":false},model:{value:(_vm.Category),callback:function ($$v) {_vm.Category=$$v},expression:"Category"}},[_c('v-radio',{attrs:{"label":"Hot (ร้อน)","value":"Hot"}}),_vm._v(" "),_c('v-radio',{attrs:{"label":"Iced (เย็น)","value":"Iced"}}),_vm._v(" "),_c('v-radio',{attrs:{"label":"Blended (ปั่น)","value":"Blended"}})],1)],1)],_vm._ssrNode(" "),[_c('v-container',{attrs:{"fluid":""}},[_c('h1',[_vm._v("Sweetness level (ระดับความหวาน)")]),_vm._v(" "),_c('v-radio-group',{attrs:{"mandatory":false},model:{value:(_vm.Sweet),callback:function ($$v) {_vm.Sweet=$$v},expression:"Sweet"}},[_c('v-radio',{attrs:{"label":"Normal (หวานปกติ)","value":"Normal"}}),_vm._v(" "),_c('v-radio',{attrs:{"label":"Medium (หวานปานกลาง)","value":"Medium"}}),_vm._v(" "),_c('v-radio',{attrs:{"label":"Not Sweet (ไม่หวาน)","value":"No Sweet"}})],1)],1)],_vm._ssrNode(" "),_c('v-row',[_c('v-col',{attrs:{"cols":"5","md":"6"}},[_c('h1',[_vm._v("Quantity (จำนวนแก้ว)")]),_vm._v(" "),_c('v-text-field',{attrs:{"number":"","required":""},model:{value:(_vm.Quantity),callback:function ($$v) {_vm.Quantity=$$v},expression:"Quantity"}})],1)],1),_vm._ssrNode(" "),_c('v-col',[_c('v-btn',{staticClass:"mr-6",attrs:{"color":"success"},on:{"click":_vm.addData}},[_vm._v(" Submit ")])],1),_vm._ssrNode(" <h1>"+_vm._ssrEscape("Total "+_vm._s(_vm.Total)+" Bath")+"</h1>")],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/order.vue?vue&type=template&id=57c5adc0&
...
/* harmony default export */ var ordervue_type_script_lang_js_ = ({
  ...
  methods: {
    addData() {
      ...
      firebaseConfig["a" /* db */].collection('Order').doc().set(dataText).then(function () {
...
var VRadio = __webpack_require__(167);
...
var _selection_controls = __webpack_require__(169);
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  ordervue_type_template_id_57c5adc0_render,
  staticRenderFns,
  false,
  null,
  null,
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCol: VCol["a" /* default */],VContainer: VContainer["a" /* default */],VRadio: VRadioGroup_VRadio,VRadioGroup: VRadioGroup_VRadioGroup,VRow: VRow["a" /* default */],VTextField: VTextField["a" /* default */]})
