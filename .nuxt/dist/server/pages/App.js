...
module.exports.__inject__ = function (context) {
  add("4363520c", content, true, context)
};
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/Product.vue?vue&type=template&id=3d44ccb0&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-card',[_c('div',{staticClass:"card-title"},[_vm._v(_vm._s(_vm.product.title))]),_vm._v(" "),_c('div',{staticClass:"text-muted card-text"},[_vm._v("\n    "+_vm._s(Number(_vm.product.price).toFixed())+" Bath\n  ")]),_vm._v(" "),_c('v-btn',{staticClass:"btn btn-info form-control",attrs:{"disabled":_vm.isInCart},on:{"click":function($event){return _vm.$emit('add-to-cart', _vm.product)}}},[_vm._v("\n    "+_vm._s(_vm.isInCart ? 'Added to cart' : 'Add to Cart')+"\n  ")])],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/Product.vue?vue&type=template&id=3d44ccb0&
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/Cart.vue?vue&type=template&id=303f6559&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<ul class=\"list-group\">","</ul>",_vm._l((_vm.items),function(item){return _c('v-list',{key:item.id},[_vm._v("\n      "+_vm._s(item.title)+" - "+_vm._s(item.price)+"\n      "),_c('v-btn',{staticClass:"btn badge badge-warning float-right",on:{"click":function($event){return _vm.$emit('remove-from-cart', item)}}},[_vm._v("\n        Remove\n      ")])],1)}),1),_vm._ssrNode(" <div class=\"card p-3 my-5\"><h4 class=\"text-center\">"+_vm._ssrEscape("Total "+_vm._s(_vm.total)+" Bath")+"</h4></div> "),_c('v-btn',{staticClass:"btn btn-info form-control",attrs:{"disabled":_vm.items.length === 0},on:{"click":_vm.addData}},[_vm._v("\n    Pay Now\n  ")])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/Cart.vue?vue&type=template&id=303f6559&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/Cart.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var Cartvue_type_script_lang_js_ = ({
  ...
  methods: {
    addData() {
      ...
      firebaseConfig["a" /* db */].collection('zxc').doc().set(dataText).then(function () {
...
// CONCATENATED MODULE: ./components/Cart.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./components/Cart.vue
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VList: VList["a" /* default */]})
...
module.exports = JSON.parse("[{\"id\":\"1\",\"title\":\"Espresso (เอสเพรสโซ่)\",\"price\":\"0\"},{\"id\":\"2\",\"title\":\"Americano (อเมริกาโน่)\",\"price\":\"0\"},{\"id\":\"3\",\"title\":\"Latte (ลาเต้)\",\"price\":\"0\"},{\"id\":\"4\",\"title\":\"Cappuccino (คาปูชิโน)\",\"price\":\"0\"},{\"id\":\"5\",\"title\":\"Mocha (มอคค่า)\",\"price\":\"0\"},{\"id\":\"7\",\"title\":\"Iced (เย็น)\",\"price\":\"0\"},{\"id\":\"8\",\"title\":\"Blended (ปั่น)\",\"price\":\"5\"},{\"id\":\"9\",\"title\":\"Small (เล็ก) 12 Oz.\",\"price\":\"30\"},{\"id\":\"10\",\"title\":\"Medium (กลาง) 16 Oz.\",\"price\":\"40\"},{\"id\":\"11\",\"title\":\"Large (ใหญ่) 20 Oz.\",\"price\":\"50\"},{\"id\":\"12\",\"title\":\"Normal (หวานปกติ)\",\"price\":\"0\"},{\"id\":\"13\",\"title\":\"Medium (หวานปานกลาง)\",\"price\":\"0\"},{\"id\":\"14\",\"title\":\"Not Sweet (ไม่หวาน)\",\"price\":\"0\"},{\"id\":\"15\",\"title\":\"Chewy tapioca balls (ไข่มุก)\",\"price\":\"5\"},{\"id\":\"16\",\"title\":\"Whipped cream (วิปปิ้งครีม)\",\"price\":\"5\"}]");
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, "body{background-color:#dcdcdc}", ""]);
// Exports
module.exports = exports;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/App.vue?vue&type=template&id=24041d68&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container mt-4"},[_c('v-row',[_c('div',{staticClass:"col-md-7"},[_c('v-row',_vm._l((_vm.products),function(product){return _c('div',{key:product.id,staticClass:"col-md-4"},[_c('product',{attrs:{"is-in-cart":_vm.isInCart(product),"product":product},on:{"add-to-cart":function($event){return _vm.addToCart(product)}}})],1)}),0)],1),_vm._v(" "),_c('div',{staticClass:"col-md-5 my-5"},[_c('cart',{attrs:{"items":_vm.cart},on:{"pay":function($event){return _vm.pay()},"remove-from-cart":function($event){return _vm.removeFromCart($event)}}})],1)])],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/App.vue?vue&type=template&id=24041d68&

// EXTERNAL MODULE: ./components/products.json
var products = __webpack_require__(195);

// EXTERNAL MODULE: ./components/Product.vue + 4 modules
var Product = __webpack_require__(190);

// EXTERNAL MODULE: ./components/Cart.vue + 4 modules
...
installComponents_default()(component, {Product: __webpack_require__(190).default,Cart: __webpack_require__(191).default})
