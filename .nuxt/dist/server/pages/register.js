...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/register.vue?vue&type=template&id=0cd4d690&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-card',{staticClass:"mx-auto",attrs:{"width":"500","height":"700","outlined":""}},[_c('h1',{attrs:{"align":"center"}},[_vm._v("SignUp")]),_vm._v(" "),_c('v-container',[_c('v-row',[_c('v-col',[_c('v-text-field',{attrs:{"name":"input-10-1","label":"ชื่อ","rules":[
            ...
            function (v) { return (v && v.replace(/[^0-9/*-+.!@#$%&*():}{}<>,]/g, '') < 1) ||
              'Please enter only characters.'; } ]},model:{value:(_vm.lastname),callback:function ($$v) {_vm.lastname=$$v},expression:"lastname"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-menu',{ref:"menu",attrs:{"close-on-content-click":false,"transition":"scale-transition","offset-y":"","min-width":"290px"},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
          var on = ref.on;
          var attrs = ref.attrs;
return [_c('v-text-field',_vm._g(_vm._b({attrs:{"label":"วัน/เดือน/ปีเกิด","prepend-icon":"mdi-calendar","readonly":""},model:{value:(_vm.date),callback:function ($$v) {_vm.date=$$v},expression:"date"}},'v-text-field',attrs,false),on))]}}]),model:{value:(_vm.menu),callback:function ($$v) {_vm.menu=$$v},expression:"menu"}},[_vm._v(" "),_c('v-date-picker',{ref:"picker",attrs:{"max":new Date().toISOString().substr(0, 10),"min":"1950-01-01"},on:{"change":_vm.save},model:{value:(_vm.date),callback:function ($$v) {_vm.date=$$v},expression:"date"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',[_c('v-text-field',{attrs:{"name":"input-13","label":"เลขประจำตัวประชาชน 13 หลัก","rules":[function (v) { return !!v || 'ID Card is required'; }]},model:{value:(_vm.ID),callback:function ($$v) {_vm.ID=$$v},expression:"ID"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',[_c('v-text-field',{attrs:{"name":"input-10-1","label":"Email","rules":[function (v) { return /.+@.+\..+/.test(v) || 'Types must be valid'; }]},model:{value:(_vm.email),callback:function ($$v) {_vm.email=$$v},expression:"email"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',[_c('v-text-field',{attrs:{"append-icon":_vm.show1 ? 'mdi-eye' : 'mdi-eye-off',"type":_vm.show1 ? 'text' : 'password',"name":"input-10-1","label":"Password"},on:{"click:append":function($event){_vm.show1 = !_vm.show1}},model:{value:(_vm.password),callback:function ($$v) {_vm.password=$$v},expression:"password"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',[_c('v-btn',{attrs:{"block":"","elevation":"2","large":"","x-small":"","color":"brown darken-4"},on:{"click":_vm.singup}},[_vm._v("SUBMIT")])],1)],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/register.vue?vue&type=template&id=0cd4d690&
...
var VDatePickerTitle = __webpack_require__(206);
...
var VDatePickerHeader = __webpack_require__(208);
...
var VDatePickerTable = __webpack_require__(210);
...
var VDatePickerYears = __webpack_require__(212);
...
var VPicker = __webpack_require__(204);

// EXTERNAL MODULE: ./node_modules/vuetify/src/components/VCard/VCard.sass
var VCard_VCard = __webpack_require__(148);
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCol: VCol["a" /* default */],VContainer: VContainer["a" /* default */],VDatePicker: VDatePicker,VMenu: VMenu["a" /* default */],VRow: VRow["a" /* default */],VTextField: VTextField["a" /* default */]})
