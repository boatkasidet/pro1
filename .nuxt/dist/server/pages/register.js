...
"use strict";
/* harmony import */ var _src_components_VProgressLinear_VProgressLinear_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(133);
...
/* harmony import */ var _mixins_positionable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(25);
/* harmony import */ var _mixins_proxyable__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(43);
...
/* harmony default export */ __webpack_exports__["a"] = (baseMixins.extend({
  ...
  computed: {
    ...
    __cachedDeterminate() {
      return this.$createElement('div', this.setBackgroundColor(this.color, {
        ...
        style: {
          width: Object(_util_helpers__WEBPACK_IMPORTED_MODULE_6__[/* convertToUnit */ "g"])(this.normalizedValue, '%')
        }
      }));
    },
    ...
    __cachedStream() {
      ...
      return this.$createElement('div', this.setTextColor(this.color, {
        ...
        style: {
          width: Object(_util_helpers__WEBPACK_IMPORTED_MODULE_6__[/* convertToUnit */ "g"])(100 - this.normalizedBuffer, '%')
        }
      }));
    },
    ...
    backgroundStyle() {
      ...
      return {
        ...
        [this.isReversed ? 'right' : 'left']: Object(_util_helpers__WEBPACK_IMPORTED_MODULE_6__[/* convertToUnit */ "g"])(this.normalizedValue, '%'),
        width: Object(_util_helpers__WEBPACK_IMPORTED_MODULE_6__[/* convertToUnit */ "g"])(this.normalizedBuffer - this.normalizedValue, '%')
      };
    },
    ...
    styles() {
      ...
      if (!this.indeterminate && parseFloat(this.normalizedBuffer) !== 100) {
        styles.width = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_6__[/* convertToUnit */ "g"])(this.normalizedBuffer, '%');
      }
  ...
  methods: {
    genContent() {
      const slot = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_6__[/* getSlot */ "s"])(this, 'default', {
  ...
  render(h) {
    const data = {
      ...
      style: {
        ...
        height: this.active ? Object(_util_helpers__WEBPACK_IMPORTED_MODULE_6__[/* convertToUnit */ "g"])(this.height) : 0,
...
/* harmony import */ var _components_VProgressLinear__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(132);
...
var validatable = __webpack_require__(129);
...
/* harmony import */ var firebase_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(115);
/* harmony import */ var firebase_app__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(firebase_app__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var firebase_firestore__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(117);
/* harmony import */ var firebase_firestore__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(firebase_firestore__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var firebase_auth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(59);
/* harmony import */ var firebase_auth__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(firebase_auth__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var firebase_storage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(118);
...
"use strict";
/* harmony import */ var _VProgressLinear__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(126);
...
/* harmony import */ var _mixins_loadable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(127);
...
var VCounter = __webpack_require__(143);
...
var intersect = __webpack_require__(44);
...
var VMenu = __webpack_require__(156);
...
/* harmony default export */ var activatable = (baseMixins.extend({
  ...
  mounted() {
    const slotType = Object(helpers["t" /* getSlotType */])(this, 'activator', true);
  ...
  methods: {
    ...
    genActivator() {
      const node = Object(helpers["s" /* getSlot */])(this, 'activator', Object.assign(this.getValueProxy(), {
    ...
    getContentSlot() {
      return Object(helpers["s" /* getSlot */])(this, 'default', this.getValueProxy(), true);
    },
...
/* harmony default export */ var detachable = (Object(mixins["a" /* default */])(bootable["a" /* default */]).extend({
  ...
  methods: {
    getScopeIdAttrs() {
      const scopeId = Object(helpers["p" /* getObjectValueByPath */])(this.$vnode, 'context.$options._scopeId');
      return scopeId && {
        [scopeId]: ''
      };
    },
...
/* harmony default export */ var stackable = (external_vue_default.a.extend().extend({
  ...
  computed: {
    activeZIndex() {
      ...
      const index = !this.isActive ? Object(helpers["u" /* getZIndex */])(content) : this.getMaxZIndex(this.stackExclude || [content]) + 2;
  ...
  methods: {
    getMaxZIndex(exclude = []) {
      ...
      const zis = [this.stackMinZIndex, Object(helpers["u" /* getZIndex */])(base)]; // Convert the NodeList to an array to
      ...
      for (let index = 0; index < activeElements.length; index++) {
        if (!exclude.includes(activeElements[index])) {
          zis.push(Object(helpers["u" /* getZIndex */])(activeElements[index]));
        }
      }
...
"use strict";
/* harmony import */ var _src_components_VGrid_VGrid_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(60);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/register.vue?vue&type=template&id=50555bd3&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('v-card',{staticClass:"mx-auto",attrs:{"width":"500","outlined":""}},[_c('v-container',[_c('h1',{attrs:{"align":"center"}},[_vm._v("SignUp")]),_vm._v(" "),_c('v-row',[_c('v-col',[_c('v-text-field',{attrs:{"name":"input-10-1","label":"ชื่อ","rules":[
              function (v) { return !!v || 'Name is required'; },
              function (v) { return (v && v.replace(/[^0-9/*-+.!@#$%&*():}{}<>,]/g, '') < 1) ||
                'Please enter only characters.'; } ]},model:{value:(_vm.name),callback:function ($$v) {_vm.name=$$v},expression:"name"}})],1),_vm._v(" "),_c('v-col',[_c('v-text-field',{attrs:{"name":"input-10-1","label":"นามสกุล","rules":[
              function (v) { return !!v || 'Lastname is required'; },
              function (v) { return (v && v.replace(/[^0-9/*-+.!@#$%&*():}{}<>,]/g, '') < 1) ||
                'Please enter only characters.'; } ]},model:{value:(_vm.lastname),callback:function ($$v) {_vm.lastname=$$v},expression:"lastname"}})],1)],1),_vm._v(" "),_c('v-col',[_c('v-menu',{ref:"menu",attrs:{"close-on-content-click":false,"return-value":_vm.date,"transition":"scale-transition","offset-y":"","min-width":"200px"},on:{"update:returnValue":function($event){_vm.date=$event},"update:return-value":function($event){_vm.date=$event}},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
            var on = ref.on;
            var attrs = ref.attrs;
return [_c('v-text-field',_vm._g(_vm._b({attrs:{"label":"ปีเกิด/เดือน/วัน","prepend-icon":"mdi-calendar","readonly":"","dense":""},model:{value:(_vm.date),callback:function ($$v) {_vm.date=$$v},expression:"date"}},'v-text-field',attrs,false),on))]}}]),model:{value:(_vm.menu),callback:function ($$v) {_vm.menu=$$v},expression:"menu"}},[_vm._v(" "),_c('v-date-picker',{attrs:{"no-title":"","scrollable":""},model:{value:(_vm.date),callback:function ($$v) {_vm.date=$$v},expression:"date"}},[_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"text":"","color":"primary"},on:{"click":function($event){_vm.menu = false}}},[_vm._v(" Cancel ")]),_vm._v(" "),_c('v-btn',{attrs:{"text":"","color":"primary"},on:{"click":function($event){return _vm.$refs.menu.save(_vm.date)}}},[_vm._v("\n              OK\n            ")])],1)],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',[_c('v-text-field',{attrs:{"name":"input-13","label":"เลขประจำตัวประชาชน 13 หลัก","rules":[function (v) { return !!v || 'ID Card is required'; }]},model:{value:(_vm.ID),callback:function ($$v) {_vm.ID=$$v},expression:"ID"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',[_c('v-text-field',{attrs:{"name":"input-10-1","label":"Email","rules":[function (v) { return /.+@.+\..+/.test(v) || 'Types must be valid'; }]},model:{value:(_vm.email),callback:function ($$v) {_vm.email=$$v},expression:"email"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',[_c('v-text-field',{attrs:{"append-icon":_vm.show1 ? 'mdi-eye' : 'mdi-eye-off',"type":_vm.show1 ? 'text' : 'password',"name":"input-10-1","label":"Password"},on:{"click:append":function($event){_vm.show1 = !_vm.show1}},model:{value:(_vm.password),callback:function ($$v) {_vm.password=$$v},expression:"password"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',[_c('v-btn',{attrs:{"block":"","elevation":"2","large":"","x-small":"","color":""},on:{"click":_vm.singup}},[_vm._v("SUBMIT")])],1)],1)],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/register.vue?vue&type=template&id=50555bd3&

// EXTERNAL MODULE: external "firebase/app"
var app_ = __webpack_require__(115);
var app_default = /*#__PURE__*/__webpack_require__.n(app_);

// EXTERNAL MODULE: ./plugins/firebaseConfig.js
var firebaseConfig = __webpack_require__(131);

// EXTERNAL MODULE: external "firebase/auth"
var auth_ = __webpack_require__(59);
...
/* harmony default export */ var registervue_type_script_lang_js_ = ({
  ...
  methods: {
    singup() {
      app_default.a.auth().createUserWithEmailAndPassword(this.email, this.password).then(user => {
        console.log(user);
        this.$router.push('/');
      }).catch(error => {
        this.error = error;
      ...
      firebaseConfig["a" /* db */].collection('User').doc(this.email).set(data).then(function () {
        alert('DONE');
      });
    }
...
var VCol = __webpack_require__(159);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/components/VGrid/VContainer.js + 1 modules
var VContainer = __webpack_require__(125);

// EXTERNAL MODULE: ./node_modules/vuetify/src/components/VDatePicker/VDatePickerTitle.sass
var VDatePickerTitle = __webpack_require__(175);
...
var VDatePickerHeader = __webpack_require__(177);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/components/VBtn/index.js
var components_VBtn = __webpack_require__(116);
...
var VDatePickerTable = __webpack_require__(179);
...
var VDatePickerYears = __webpack_require__(181);
...
var VCard_VCard = __webpack_require__(145);
...
var VSpacer = __webpack_require__(124);
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCol: VCol["a" /* default */],VContainer: VContainer["a" /* default */],VDatePicker: VDatePicker,VMenu: VMenu["a" /* default */],VRow: VRow["a" /* default */],VSpacer: VSpacer["a" /* default */],VTextField: VTextField["a" /* default */]})
