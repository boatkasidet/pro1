...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=4cab9758&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-card',{staticClass:"mx-auto",attrs:{"width":"500","height":"320","outlined":""}},[_c('h1',{attrs:{"align":"center"}},[_vm._v("Login")]),_vm._v(" "),_c('v-container',[_c('v-row',[_c('v-col',[_c('v-text-field',{attrs:{"name":"input-10-1","label":"Email"},model:{value:(_vm.email),callback:function ($$v) {_vm.email=$$v},expression:"email"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',[_c('v-text-field',{attrs:{"append-icon":_vm.show1 ? 'mdi-eye' : 'mdi-eye-off',"type":_vm.show1 ? 'text' : 'password',"name":"input-10-1","label":"Password"},on:{"click:append":function($event){_vm.show1 = !_vm.show1}},model:{value:(_vm.password),callback:function ($$v) {_vm.password=$$v},expression:"password"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',[_c('nuxt-link',{attrs:{"to":"register"}},[_c('v-btn',{attrs:{"block":"","elevation":"2","large":"","x-small":"","color":""}},[_vm._v("Register")])],1)],1),_vm._v(" "),_c('v-col',[_c('v-btn',{attrs:{"block":"","elevation":"2","large":"","x-small":"","color":"primary"},on:{"click":_vm.singin}},[_vm._v("LOGIN")])],1)],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=4cab9758&
...
/* harmony default export */ var lib_vue_loader_options_pagesvue_type_script_lang_js_ = ({
  ...
  methods: {
    singin() {
      app_default.a.auth().signInWithEmailAndPassword(this.email, this.password).then(user => {
        console.log(user);
    ...
    getuser() {
      firebaseConfig["a" /* db */].collection('User').where('email', '==', this.email).onSnapshot(querySnapshot => {
        /* eslint no-var: */
        var data = [];
