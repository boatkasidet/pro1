...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/table.vue?vue&type=template&id=3cdac63e&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('v-text-field',{attrs:{"append-icon":"mdi-magnify","label":"Search","single-line":"","hide-details":""},model:{value:(_vm.search),callback:function ($$v) {_vm.search=$$v},expression:"search"}}),_vm._ssrNode(" "),_c('v-data-table',{staticClass:"elevation-1",attrs:{"search":_vm.search,"headers":this.$store.state.headers,"items":(this.data = _vm.data),"items-per-page":10}})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/table.vue?vue&type=template&id=3cdac63e&
...
installComponents_default()(component, {VDataTable: VDataTable["a" /* default */],VTextField: VTextField["a" /* default */]})
